...
def create_pdf():
    ...
    # Use Helvetica font directly to avoid warnings
    pdf.set_font("Helvetica", size=16)
    
    # Add title
    pdf.cell(200, 10, text="PDF Document Generated with Python", new_x="LMARGIN", new_y="NEXT", align='C')
    
    # Add subtitle
    pdf.set_font("Helvetica", size=12)
    pdf.cell(200, 10, text="Created using fpdf2 library", new_x="LMARGIN", new_y="NEXT", align='C')
    
    # Add date
    current_time = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    pdf.cell(200, 10, text=f"Generated on: {current_time}", new_x="LMARGIN", new_y="NEXT", align='C')
    ...
    pdf.cell(200, 10, text="Section 1: Introduction", new_x="LMARGIN", new_y="NEXT")
...
"""
    ...
    pdf.ln(5)
    pdf.set_font("Helvetica", 'B', 14)
    pdf.cell(200, 10, text="Section 2: Key Points", new_x="LMARGIN", new_y="NEXT")
    ...
    for point in points:
        pdf.cell(0, 10, f"* {point}", new_x="LMARGIN", new_y="NEXT")
    
    # Section 3 - Sample table
    pdf.ln(5)
    pdf.set_font("Helvetica", 'B', 14)
    pdf.cell(200, 10, text="Section 3: Sample Data", new_x="LMARGIN", new_y="NEXT")
    ...
    pdf.cell(200, 10, text="End of document - Page 1", new_x="LMARGIN", new_y="NEXT", align='C')
